jQuery(document).ready(function() {
    "use strict";
    /*$("body").addClass("loaded2").removeClass("loaded1")
    setTimeout(function() {
    ...
    //$(window).on("load", function() {
        $('.scrolling  a[href*="#"]').on("click", function(e) {
            ...
            $(window).scroll(function() {
                o.hasClass("bb-fixed-header") && (0 === $(this).scrollTop() || $(this).width() < 767) ? (o.removeClass("bb-fixed-header").appendTo(e), s.animate({
                ...
                })) : !o.hasClass("bb-fixed-header") && $(this).width() > 767 && $(this).scrollTop() > e.offset().top + e.height() - parseInt($("html").css("margin-top"), 10) && (e.css("height", e.height()), o.css({
                    opacity: "0"
   ...
   // })
}), $(".navbar").width() > 767 && ($(".nav .dropdown").on("mouseover", function() {
    "use strict";
    $(this).addClass("show")
