                    ...
                    <div class="card-body">
                        <div class="message-box contact-box">
                            ...
                            <div class="message-widget contact-widget">
                                <!-- Message -->
                                <a href="index.html#">
                                    <div class="user-img"> <img src="assets/images/users/user.png" alt="user"
            ...
            <div class="col-lg-8 col-xlg-9 col-md-7">
                <div class="card">
                    ...
                    <ul class="nav nav-tabs profile-tab" role="tablist">
                        <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="index.html#home" role="tab">Activity</a>
                        </li>
                        <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="index.html#profile" role="tab">Profile</a>
                        </li>
                        <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="index.html#settings" role="tab">Settings</a>
                        </li>
                    </ul>
                    <!-- Tab panes -->
                        ...
                        <div class="tab-pane active" id="home" role="tabpanel">
                            <div class="card-body">
                                <div class="profiletimeline">
                                    <div class="sl-item">
                                        <div class="sl-left"> <img src="assets/images/users/user.png" alt="user"
                                                class="img-circle"> </div>
                                        <div class="sl-right">
                                            <div><a href="index.html#" class="link">John Doe</a> <span class="sl-date">5
                                                    minutes ago</span>
                                                ...
                                                <div class="m-t-20 row">
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                        <p> Lorem ipsum dolor sit amet, consectetur adipiscing
                                                            ...
                                                            ante dapibus diam. </p> <a href="index.html#" class="btn btn-success">
                                                            Design weblayout</a>
                                                    </div>
                                                </div>
